...
{
    public class ICDMOB_AEPSDatamodel
    {
        ...
        string In_AEPSO_Orderid1 = "";
        int IOU_aepso_rowid1 = 0;
        public ICDMOAEPSORDERDocument SSaveAEPS_OrderIDGenerateNew(ICDMOAEPSORDERRoot ObjFarmer, string mysqlcon)
        {
            int ret = 0;
            string errorNo = "";
            string errorMsg = "";
            ...
            ICDMOAEPSORDERDocument objsinvoice = new ICDMOAEPSORDERDocument();
            objsinvoice.context = new ICDMOBAEPSORDERContext();
            objsinvoice.ApplicationException = new ICDMOBApplicationException();
            objsinvoice.context.Header = new ICDMOBAEPSO_Order();
            Int32 IOU_aepso_rowid1 = 0;
            try
            {
                ...
                //string[] returnvalues = { };
                MySqlCommand cmd = new MySqlCommand("ICDMOB_AEPSOrderId_generation", MysqlCon.con);
                ...
                cmd.Parameters.Add("In_aepso_date", MySqlDbType.VarChar).Value = ObjFarmer.document.context.Header.In_aepso_date;
                ...
                cmd.Parameters.Add("IOU_aepso_rowid", MySqlDbType.Int32).Value = Convert.ToInt32(ObjFarmer.document.context.Header.IOU_aepso_rowid);

                cmd.Parameters.Add(new MySqlParameter("IOU_aepso_rowid1", MySqlDbType.Int32)).Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("IOU_AEPSO_Orderid1", MySqlDbType.VarChar)).Direction = ParameterDirection.Output;
                cmd.Parameters.Add(new MySqlParameter("In_AEPSO_Orderid", MySqlDbType.VarChar)).Direction = ParameterDirection.Output;
                ...
                if (ret > 0)
                {
                    ...
                    IOU_aepso_rowid1 = (Int32)cmd.Parameters["IOU_aepso_rowid1"].Value;
                    In_AEPSO_Orderid1 = (string)cmd.Parameters["In_AEPSO_Orderid"].Value;
                    objsinvoice.context.Header.IOU_aepso_rowid = IOU_aepso_rowid1;
                    objsinvoice.context.Header.In_AEPSO_Orderid = In_AEPSO_Orderid1;
        ...
        public ICDMOBAEPSHISDocument SSavePayHisReponse_AEPSDB(ICDMOBAEPSHISRoot ObjFarmer, string mysqlcon)
        {
            int ret = 0;
            string errorNo = "";
            string errorMsg = "";
            DataConnection con = new DataConnection(mysqlcon);
            MysqlCon = new DataConnection(mysqlcon);
            ICDMOBAEPSHISDocument objsinvoice = new ICDMOBAEPSHISDocument();
            objsinvoice.context = new ICDMOBAEPSHISContext();
            objsinvoice.context.Header = new ICDMOBAEPSHIS();
            ...
            try
            {
                ...
                //string[] returnvalues = { };
                MySqlCommand cmd = new MySqlCommand("ICDMOB_insupd_AEPSpaymenthistory", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public ICDInvoiceAEPSApplication GetICDInvoiceAEPSfetch(ICDInvoicePaymentContext ObjContext, string mysqlcon)
        {
            DataTable dt = new DataTable();
            ICDInvoiceAEPSApplication ObjinvRoot = new ICDInvoiceAEPSApplication();
            ICDMOB_PAYTMDatamodel objDataModel = new ICDMOB_PAYTMDatamodel();
            ObjinvRoot.context = new ICDInvoicePaymentContext();
            ObjinvRoot.context.List = new List<InvoiceAEPSfetchlist>();
            MysqlCon = new DataConnection(mysqlcon);

            try
            {
                MySqlCommand cmd = new MySqlCommand("AEPSonline_Paymentfetch", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    InvoiceAEPSfetchlist objList = new InvoiceAEPSfetchlist();
