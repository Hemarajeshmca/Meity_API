...
{
    public class Admin_UserManagementDataModel
    {
        ...
        log4net.ILog logger = log4net.LogManager.GetLogger(typeof(Admin_UserManagementDataModel));
        ...
        public UserManagementOutput SaveUserMap(SaveMapRoot objRole, string ConString)
        {
            UserManagementOutput objOut = new UserManagementOutput();
            // Exception Log Method Name Purpose written start 
            string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
            ...
            try
            {
                ...
                FFI_Model.ApplicationException objEx = new FFI_Model.ApplicationException();
                MySqlCommand cmd = new MySqlCommand("Admin_insupd_usermapping", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add("In_parent_code", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_parent_code;
                cmd.Parameters.Add("In_orgn_code", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_orgn_code;
                cmd.Parameters.Add("In_user_code", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_user_code;
                cmd.Parameters.Add("In_orgn_level", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_orgn_level;
                cmd.Parameters.Add("In_fpo_code", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_fpo_code;
                cmd.Parameters.Add("In_status_code", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_status_code;
                cmd.Parameters.Add("In_mode_flag", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_mode_flag;
                cmd.Parameters.Add("In_row_timestamp", MySqlDbType.VarChar).Value = objRole.document.context.Header.In_row_timestamp;
                cmd.Parameters.Add("userId", MySqlDbType.VarChar).Value = objRole.document.context.userId;
        ...
        public FPOUSERList GetAllFpoList(string org, string locn, string user, string lang, string user_code, string ConString)
        {
            FPOUSERList ObjFetchAll = new FPOUSERList();
            // Exception Log Method Name Purpose written start 
            string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
            //End
            try
            {
                DataSet ds = new DataSet();
                DataTable dtfpo = new DataTable();
                MysqlCon = new DataConnection(ConString);
                fpoContext objContext = new fpoContext();
                objContext.orgnId = org;
                objContext.localeId = lang;
                objContext.locnId = locn;
                objContext.userId = user;
                ObjFetchAll.context = objContext;
                MySqlCommand cmd = new MySqlCommand("Admin_fetch_fpo_list", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.Add(new MySqlParameter("out_user_code", MySqlDbType.VarChar)).Direction = ParameterDirection.Output;
                ...
                {
                    dtfpo = ds.Tables[0];
                    List<FpoListdetail> objRoleLst = new List<FpoListdetail>();
                    for (int i = 0; i < dtfpo.Rows.Count; i++)
                    {
                        FpoListdetail objList = new FpoListdetail();
                        objList.fpo_code = dtfpo.Rows[i]["fpo_code"].ToString();
                        objList.fpo_desc = dtfpo.Rows[i]["fpo_desc"].ToString();
                ...
                FpoList objHeader = new FpoList();
                objHeader.parent_code = (string)cmd.Parameters["out_parent_code"].Value.ToString();
                objHeader.user_code = (string)cmd.Parameters["out_user_code"].Value.ToString();
        ...
        public RIUserManagementList GetMapUsersList(string org, string locn, string user, string lang, string Mysql)
        {
            RIUserManagementList ObjFetchAll = new RIUserManagementList();
            // Exception Log Method Name Purpose written start 
            string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
            //End
            try
            {
                ...
                DataTable dt = new DataTable();
                MysqlCon = new DataConnection(Mysql);
                RIUserContext objContext = new RIUserContext();
                objContext.orgnId = org;
                objContext.localeId = lang;
                objContext.locnId = locn;
                objContext.userId = user;
                ObjFetchAll.context = objContext;
                MySqlCommand cmd = new MySqlCommand("Admin_fetch_userRI_list", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                List<RIUserList> objRoleLst = new List<RIUserList>();
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    RIUserList objList = new RIUserList();
                    objList.orgn_code = dt.Rows[i]["orgn_code"].ToString();
                    objList.orgn_desc = dt.Rows[i]["orgn_desc"].ToString();
                    objList.user_code = dt.Rows[i]["user_code"].ToString();
                    objList.user_name = dt.Rows[i]["user_name"].ToString();
        ...
        public FPOListGL GetFPOlist(string org, string locn, string user, string lang, string Mysql)
        {
            FPOListGL ObjFetchAll = new FPOListGL();
            // Exception Log Method Name Purpose written start 
            string methodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
            //End
            try
            {
                ...
                DataTable dt = new DataTable();
                MysqlCon = new DataConnection(Mysql);
                FPOLISTContext objContext = new FPOLISTContext();
                objContext.orgnId = org;
                objContext.localeId = lang;
                objContext.locnId = locn;
                objContext.userId = user;
                ObjFetchAll.context = objContext;
                MySqlCommand cmd = new MySqlCommand("Admin_fetch_fpoall_list", MysqlCon.con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                List<FpoListG> objRoleLst = new List<FpoListG>();
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    FpoListG objList = new FpoListG();
                    objList.fpo_code = dt.Rows[i]["fpo_code"].ToString();
                    objList.fpo_desc = dt.Rows[i]["fpo_desc"].ToString();
