...
{
    public class MasterDefinition_DB
    {
        private MySqlConnection con;
        MySqlTransaction mysqltrans;
        public DataConnection MysqlCon;
        ErrorMessages ObjErrormsg = new ErrorMessages();
        log4net.ILog logger = log4net.LogManager.GetLogger(typeof(MasterDefinition_DB));
        ...
        public Master_DocumentSave MasterDefinition_Save(Master_RootSave ObjICDSupplier, string MysqlCons)
        {
            ...
            try
            {
                MasterDefinition_DB objdb = new MasterDefinition_DB();
