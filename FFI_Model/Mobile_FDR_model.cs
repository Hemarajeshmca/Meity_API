...
namespace FFI_Model
{
    ...
    {
        public int Out_paytm_masid { get; set; }
        public string Out_paytm_fpocode { get; set; }
        public string Out_paytm_type { get; set; }
        public string Out_paytm_merchantId { get; set; }
        public string Out_paytm_tid { get; set; }
        public string Out_paytm_merchantkey { get; set; }
    }
    public class AEPSDetails
    {
        public int Out_AEPS_masid { get; set; }
        public string Out_AEPS_fpocode { get; set; }
        public string Out_AEPS_type { get; set; }
        public string Out_AEPS_merchantId { get; set; }
        public string Out_AEPS_tid { get; set; }
        public string Out_AEPS_merchantkey { get; set; }
    }
    public class MFMContext
    {
        ...
        public IList<PaytmDetails> PaytmMasterDt { get; set; }
        public IList<AEPSDetails> AEPSMasterDt { get; set; }
